...
# $Header: $
# This ebuild come from http://bugs.gentoo.org/show_bug.cgi?id=87553 - The site http://gentoo.zugaina.org/ only host a copy.
...
IUSE="aalib altivec debug doc gtkhtml jpeg mmx mng png python sse svg tiff wmf"
