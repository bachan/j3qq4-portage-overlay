...
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="debug gnome-keyring lensfun openmp"
...
src_compile() {
	econf $(use_enable debug) $(use_enable gnome-keyring gkeyring) \
		$(use_enable lensfun) $(use_enable openmp) \
		--disable-schemas-install || die "econf failed."
