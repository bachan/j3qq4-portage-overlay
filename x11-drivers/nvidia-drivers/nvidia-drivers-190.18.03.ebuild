...
SRC_URI="x86? ( http://developer.download.nvidia.com/opengl/3.2/linux/${X86_NV_PACKAGE}-pkg1.run )
	 amd64? ( http://developer.download.nvidia.com/opengl/3.2/linux/${AMD64_NV_PACKAGE}-pkg2.run )
	 x86-fbsd? ( http://developer.download.nvidia.com/opengl/3.2/freebsd/${X86_FBSD_NV_PACKAGE}.tar.gz )"
